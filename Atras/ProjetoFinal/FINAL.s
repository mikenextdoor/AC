...
generate_random:
    ...
    ; 1. Chama rand para gerar o primeiro número aleatório
    bl      rand        ; r0 = rand() (primeiro número aleatório)
    mov     r4, r0     ; Salva o primeiro número aleatório em r4

    ; 2. Chama rand novamente para gerar o segundo número aleatório
    bl      rand        ; r0 = rand() (segundo número aleatório)
    mov     r5, r0     ; Salva o segundo número aleatório em r5

    ; 3. Usa o valor gerado para pegar o valor correspondente no array
    ; Suponha que o número aleatório gerado seja usado para acessar um array
    ; Aqui estamos pegando o valor de r4 (primeiro valor gerado) para exibir no display
    ldr     r3, array_addr       ; Carrega o endereço do array
    ldrb    r3, [r3, r4]         ; Acessa o valor do array com base no valor gerado

    ; 4. Escreve o valor no display
    mov     r0, r3               ; Coloca o valor do array em r0
    bl      outport_write        ; Exibe o número gerado no display
